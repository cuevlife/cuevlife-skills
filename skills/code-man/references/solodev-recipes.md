...
โปรเจคที่ดูแลคนเดียว ไม่มีทีม ops คอยรัน migration/sql มือให้ — 4 pattern คอนกรีตที่ implement ได้ทันที เลือกทำเฉพาะที่ต้องการจริง ไม่ใช่ทำครบทุกครั้ง (ดู "Extensible Architecture" ใน SKILL.md ข้อ 5 — เช็คว่าต้องการอันไหนจริงก่อนเปิดไฟล์นี้)
